    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            const Text("Mohammad", style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold),),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                const Divider(color: Color(0xFF181D1E), thickness: 2, indent: 10,endIndent: 10,),
